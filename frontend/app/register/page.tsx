...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen w-full flex bg-slate-50">
      {/* Left Column: 3D Illustration & Branding (Image 4) */}
      <div className="hidden lg:flex lg:w-[48%] bg-gradient-to-br from-indigo-50 via-slate-100 to-purple-50 p-12 flex-col justify-between items-center text-center relative border-r border-slate-200">
        ...
        <div className="max-w-md w-full flex flex-col items-center my-auto">
          ...
          <p className="text-xs text-slate-500 leading-relaxed max-w-sm">
            Join thousands of professional teams managing complex projects with clarity, speed, and precision.
          </p>
        </div>

        <div className="w-full flex items-center justify-between text-xs text-slate-400">
          <span>© 2026 TaskFlow Pro Inc.</span>
      ...
      {/* Right Column: Form (Image 4) */}
      <div className="w-full lg:w-[52%] flex flex-col justify-center p-8 sm:p-14 md:p-20 bg-white">
        <div className="max-w-md w-full mx-auto">
          ...
          {/* Enterprise Provisioning Callout */}
          <div className="mb-6 p-4 rounded-xl bg-indigo-50/70 border border-indigo-100 flex items-start space-x-3 text-xs text-indigo-900 leading-relaxed">
            ...
            <div>
              <span className="font-semibold block mb-0.5">Enterprise Provisioning</span>
              <span>If your organization uses SSO, please contact your IT administrator to be provisioned into your corporate workspace.</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-[11px] text-slate-400">
              Minimum 6 characters with at least one number and special character.
            </p>
            ...
            <div className="flex items-start pt-1">
              ...
              />
              <label htmlFor="agreeTerms" className="ml-2 text-xs text-slate-600 select-none leading-relaxed">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 px-4 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-sm shadow-md shadow-indigo-600/25 transition-all flex items-center justify-center space-x-2 disabled:opacity-50"
            >
              {loading ? (
                <>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <button
              type="button"
              className="flex items-center justify-center space-x-2 py-2 px-4 rounded-xl border border-slate-200 hover:bg-slate-50 transition-colors text-xs font-semibold text-slate-700 shadow-sm"
            >
